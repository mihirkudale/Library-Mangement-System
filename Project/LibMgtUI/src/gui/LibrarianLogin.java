...
public class LibrarianLogin extends JFrame {
    ...
    public static void viewLibrarianLogin() {
        try {
...
//                    LibrarianSuccess.viewLibrarianSuccess();
                    LibrarianSuccesss libfrm = new LibrarianSuccesss();
                    libfrm.setSize(750, 800);
                    libfrm.setVisible(true);
                    libfrm.setLocationRelativeTo(null);
                    frame.dispose();
                } else {
